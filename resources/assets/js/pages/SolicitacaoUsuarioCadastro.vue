        ...
        <div class="panel panel-form">
            <div class="panel-body">
                <div class="alert alert-success" role="alert" v-show="success">
                    <h4>Sua solicitação foi enviada com sucesso!</h4>
                ...
                <div v-show="!success">
                    <form role="form" accept-charset="UTF-8" @submit.prevent="save">
                        ...
                        <form-control :error="errors.slc_titulo">
                            ...
                            <input type="text" id="slc_titulo" class="form-control" v-model="solicitacao.slc_titulo" placeholder="Informe uma breve descrição da solicitação...">
                        </form-control>
                        ...
                        <form-control :error="errors.slc_anexo">
                            ...
                            <input type="file" id="slc_anexo" class="form-control" v-on:change="onFileChange">
                        </form-control>

                        <form-control :error="errors.slc_anexo_2" v-if="qtdAnexos >= 2">
                            <input type="file" id="slc_anexo_2" class="form-control" v-on:change="onFileChange">
                        </form-control>

                        <form-control :error="errors.slc_anexo_3" v-if="qtdAnexos >= 3">
                            <input type="file" id="slc_anexo_3" class="form-control" v-on:change="onFileChange">
                        </form-control>
                        ...
                        <a :href="baseUrl('/esic/solicitacoes')" class="btn btn-default">Voltar</a>
                    </form>
                </div>
            </div>
        </div>
        ...
        methods: {
            save() {
                ...
                promise
                    .then((response) => {
                        this.success = true;
                        this.protocolo = response.data.data.slc_protocolo;
                        Loading.hide();
                    })
                    .catch((error) => {
                        if (error.response) {
