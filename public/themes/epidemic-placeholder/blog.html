                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <label for="name"><i class="linearicons-user"></i>Your Name</label>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                <input class="form-control" type="text" id="email" name="email" placeholder="" />
                                <label for=""><i class="linearicons-envelope-open"></i>Your Email
                                    Address</label>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <label for=""><i class="linearicons-telephone"></i>Your Phone
                                    Number</label>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <label for=""><i class="linearicons-document"></i>Your Message</label>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group checkbox_field">
                                <div class="checkbox">
                                    ...
                                    <label class="l_text" for="squared2">I accept the <span>Privacy
                                            Policy</span></label>
                                </div>
            ...
            <div class="container">
                ...
                <div class="row blog_item_inner">
                    <div class="col-lg-6 comm travel edu quarantine">
                        <div class="big_l_blog_item">
                            <div class="l_blog_img">
                                <img class="img-fluid" src="assets/images/blog/blog-grid/blog-1.jpg" alt="" />
                            </div>
                    ...
                    <div class="col-lg-6 medi">
                        <div class="big_l_blog_item">
                            <div class="l_blog_img">
                                <img class="img-fluid" src="assets/images/blog/blog-grid/blog-2.jpg" alt="" />
                            </div>
                            <div class="l_blog_text">
                                <div class="date">
                    ...
                    <div class="col-lg-6 travel pre quarantine">
                        <div class="big_l_blog_item">
                            <div class="l_blog_img">
                                <img class="img-fluid" src="assets/images/blog/blog-grid/blog-3.jpg" alt="" />
                            </div>
                            <div class="l_blog_text">
                                <div class="date">
                    ...
                    <div class="col-lg-6 edu pre">
                        <div class="big_l_blog_item">
                            <div class="l_blog_img">
                                <img class="img-fluid" src="assets/images/blog/blog-grid/blog-4.jpg" alt="" />
                            </div>
                            <div class="l_blog_text">
                                <div class="date">
                    ...
                    <div class="col-lg-6 health">
                        <div class="big_l_blog_item">
                            <div class="l_blog_img">
                                <img class="img-fluid" src="assets/images/blog/blog-grid/blog-5.jpg" alt="" />
                            </div>
                            <div class="l_blog_text">
                                <div class="date">
                    ...
                    <div class="col-lg-6 comm pre travel health">
                        <div class="big_l_blog_item">
                            <div class="l_blog_img">
                                <img class="img-fluid" src="assets/images/blog/blog-grid/blog-6.jpg" alt="" />
                            </div>
                            <div class="l_blog_text">
                                <div class="date">
                    ...
                    <div class="col-lg-6 edu">
                        <div class="big_l_blog_item">
                            <div class="l_blog_img">
                                <img class="img-fluid" src="assets/images/blog/blog-grid/blog-7.jpg" alt="" />
                            </div>
                            <div class="l_blog_text">
                                <div class="date">
                    ...
                    <div class="col-lg-6 eff edu medi">
                        <div class="big_l_blog_item">
                            <div class="l_blog_img">
                                <img class="img-fluid" src="assets/images/blog/blog-grid/blog-8.jpg" alt="" />
                            </div>
                            <div class="l_blog_text">
                                <div class="date">
                    ...
                    <div class="col-lg-6 pre medi">
                        <div class="big_l_blog_item">
                            <div class="l_blog_img">
                                <img class="img-fluid" src="assets/images/blog/blog-grid/blog-9.jpg" alt="" />
                            </div>
                            <div class="l_blog_text">
                                <div class="date">
                    ...
                    <div class="col-lg-6 quarantine eff">
                        <div class="big_l_blog_item">
                            <div class="l_blog_img">
                                <img class="img-fluid" src="assets/images/blog/blog-grid/blog-10.jpg" alt="" />
                            </div>
                            <div class="l_blog_text">
                                <div class="date">
